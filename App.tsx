...
class Page extends Component<any, State> {
  ...
  public render(): ReactElement {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <Text style={styles.titleTxt}>Size File</Text>
        <Text style={styles.titleTxt}>{this.state.fileSize} Bytes</Text>
  ...
  private onStopRecord = async (): Promise<void> => {
    ...
    console.log(result);
    var re = 'file://';
    const path_to_file = result.replace(re, "");
    const { size } = await RNFetchBlob.fs.stat(path_to_file)
    ...
    //   const d =  await RNFetchBlob.fetch(
